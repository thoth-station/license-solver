...
class TestSolver:
    ...
    def test_solver(self):
        ...
        assert str(out) == str(
            ...
            '"identifier": "MIT"}, "license_version": "LICENSE-WITHOUT-VERSION", '
            '"classifier": [["License :: OSI Approved :: MIT License", "MIT License"]], '
            '"warning": false}}, "cwltool": {"1.0.20160108200940": {"license": '
            ...
            '[["UNDETECTED"]], "warning": false}}, "itk-segmentation": {"4.13.2": '
            ...
            'License"]], "warning": false}}, "moto": {"1.3.15.dev221": {"license": '
            '{"full_name": "Apache", "identifier_spdx": "UNDETECTED", "identifier": '
            '"UNDETECTED"}, "license_version": "UNDETECTED", "classifier": [["License :: '
            'OSI Approved :: Apache Software License", "Apache Software License"]], '
            '"warning": false}}, "SQLAlchemy": {"1.3.15": {"license": {"full_name": '
            '"Apache License 1.1", "identifier_spdx": "Apache-1.1", "identifier": "Apache '
            '1.1"}, "license_version": "1.1", "classifier": [["License :: OSI Approved :: '
            'MIT License", "MIT License"]], "warning": true}, "9.10": {"license": '
            ...
            '"classifier": [["License :: OSI Approved :: MIT License", "MIT License"]], '
            '"warning": true}}, "great-expectations": {"0.11.0b0": {"license": '
            '{"full_name": "Apache License 2.0", "identifier_spdx": "Apache-2.0", '
            '"identifier": "Apache 2.0"}, "license_version": "2.0", "classifier": '
            '[["License :: OSI Approved :: Apache Software License", "Apache Software '
            'License"]], "warning": false}}, "path.py": {"2.6.1": {"license": '
            '{"full_name": "MIT License", "identifier_spdx": "MIT", "identifier": "MIT"}, '
            '"license_version": "LICENSE-WITHOUT-VERSION", "classifier": [["License :: '
