        ...
        assert str(out) == str(
            (
                (
                    ...
                    'License"]], "warning": false}}, "path.py": {"2.6.1": {"license": ["MIT '
                    'License", "MIT"], "license_version": "LICENSE-WITHOUT-VERSION", '
                    '"classifier": [["License :: OSI Approved :: MIT License", "MIT License"]], '
                    '"warning": false}}, "SQLAlchemy": {"1.3.15": {"license": ["Apache License '
                    '1.1", "Apache-1.1", "Apache 1.1"], "license_version": "1.1", "classifier": '
                    '[["License :: OSI Approved :: MIT License", "MIT License"]], "warning": '
                    "true}}}\n"
                )
            )
