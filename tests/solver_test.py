...
class TestSolver:
    ...
    def test_solver(self):
        ...
        assert str(out) == str(
            ...
            '"license_version": "LICENSE-WITHOUT-VERSION", "classifier": [["License :: '
            'OSI Approved :: MIT License", "MIT License"]], "warning": false}}, "moto": '
            '{"1.3.15.dev221": {"license": ["Apache"], "license_version": "UNDETECTED", '
            '"classifier": [["License :: OSI Approved :: Apache Software License", '
            '"Apache Software License"]], "warning": false}}, "setuptools-scm": '
            '{"1.15.4": {"license": ["MIT License", "MIT"], "license_version": '
            '"LICENSE-WITHOUT-VERSION", "classifier": [["License :: OSI Approved :: MIT '
            'License", "MIT License"]], "warning": false}}, "itk-segmentation": '
            '{"4.13.2": {"license": ["Apache"], "license_version": "UNDETECTED", '
            '"classifier": [["License :: OSI Approved :: Apache Software License", '
            '"Apache Software License"]], "warning": false}}, "great-expectations": '
            '{"0.11.0b0": {"license": ["Apache License 2.0", "Apache-2.0", "Apache 2.0"], '
            '"license_version": "2.0", "classifier": [["License :: OSI Approved :: Apache '
            'Software License", "Apache Software License"]], "warning": false}}, '
            '"path.py": {"2.6.1": {"license": ["MIT License", "MIT"], "license_version": '
            '"LICENSE-WITHOUT-VERSION", "classifier": [["License :: OSI Approved :: MIT '
            'License", "MIT License"]], "warning": false}}, "SQLAlchemy": {"1.3.15": '
            '{"license": ["Apache License 1.1", "Apache-1.1", "Apache 1.1"], '
            '"license_version": "1.1", "classifier": [["License :: OSI Approved :: MIT '
            'License", "MIT License"]], "warning": true}}}\n'
        )
